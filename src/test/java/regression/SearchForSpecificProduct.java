...
public class SearchForSpecificProduct extends TestBase {

    final static private String PAGE_TITLE = "EHS - Home";
    final static private String TABLE_HEADER_TITLE = "EHS - Item";
    ...
    @Parameters({"row","searchedID"})
    @Test(priority = 1)
    public void clickViewItemsButton(int row, int searchedID)throws IOException{
        new HomePage(driver).searchForProduct(getItem(row)[searchedID]);
    }
